  ...
  },
{
  ...
  commonName: "Brazilian Salmon Pink Birdeater",
  origin: "severovýchodní Brazílie, zejména oblast Paraíby",
  type: "pozemní sklípkan (terestriální druh, který může vytvářet mělké nory)",
  adultSize: "přibližně 20–25 cm rozpětí nohou (výjimečně i více)",
  lifespan: "samice až 15–20 let, samec přibližně 3–6 let",

  logo: "img/logos/l.parahybana-logo.webp",
  image: "img/spiders/lasiodora-parahybana.jpg",
  ...
  care: {
    terrarium: "horizontální typ s dostatečnou plochou dna (např. přibližně 40 × 30 × 30 cm nebo větší pro dospělého jedince)",
    hides: "korková kůra, kořen nebo jiný jednoduchý úkryt na zemi",
    temperature: "přibližně 24–28 °C",
    humidity: "střední vlhkost prostředí, přibližně 60–70 %; substrát by neměl být trvale přemokřený",
    substrate: "kokosová drť nebo směs terarijní půdy o hloubce přibližně 8–12 cm, která umožní vytváření mělkých úkrytů"
  },
  ...
  },
{
  ...
  latinName: "Psalmopoeus cambridgei",
  commonName: "Trinidad Chevron Tarantula",
  origin: "Karibik – ostrov Trinidad",
  type: "stromový sklípkan (arboreální druh)",
  adultSize: "přibližně 15–18 cm rozpětí nohou",
  lifespan: "samice přibližně 10–15 let, samec kolem 3–4 let",

  logo: "img/logos/p.cambridgei-logo.webp",
  image: "img/spiders/psalmopoeus-cambridgei.jpg",
  ...
  description: [
    "Psalmopoeus cambridgei je rychlý a velmi agilní stromový sklípkan pocházející z tropických vlhkých lesů ostrova Trinidad. Je známý svým hnědo-olivovým až bronzovým zbarvením a výrazným chevronovým (vzor připomínající rybí kost) kreslením na zadečku, podle kterého získal svůj anglický název „Chevron Tarantula“.",
    "V přírodě obývá především dutiny stromů, praskliny v kůře nebo hustou vegetaci, kde si vytváří pavučinové tunely nebo trubicové úkryty. Jedná se o velmi rychlý druh, který při vyrušení většinou okamžitě prchá do úkrytu. Díky své rychlosti a aktivní povaze je tento sklípkan doporučován spíše zkušenějším nebo alespoň středně pokročilým chovatelům.",
    "Zajímavostí je, že ačkoliv Psalmopoeus cambridgei patří mezi druhy Nového světa (New World), nemá obranné chloupky, které jsou pro většinu amerických sklípkanů typické. Rod Psalmopoeus tyto chloupky evolučně ztratil a při obraně proto spoléhá především na rychlý útěk, případně výstražný postoj a kousnutí."
  ],

  care: {
    terrarium: "vertikální typ s dostatkem prostoru na šplhání (např. 30 × 30 × 45 cm pro dospělého jedince)",
    hides: "korková kůra, dutý kus dřeva nebo jiný vysoký úkryt umožňující vytvoření pavučinového tunelu",
    temperature: "přibližně 24–28 °C",
    humidity: "kolem 65–80 %",
    substrate: "kokosová drť nebo směs terarijní půdy (cca 5–8 cm)"
  },
  ...
  },
{
  ...
  },
  {
    continent: "Amerika",
    genus: "Sericopelma",
    species: "Sericopelma sp. Santa Catalina"
  },
  {
    continent: "Amerika",
    genus: "Tapinauchenius",
    species: "Tapinauchenius sp. Casanare"
  },
  {
    continent: "Amerika",
    genus: "Tliltocatl",
  ...
  },
  {
    continent: "Amerika",
    genus: "Tliltocatl",
    species: "Tliltocatl epicureanus"
  },
  {
    continent: "Amerika",
    genus: "Tliltocatl",
  ...
  },
{
...
},
  {
    continent: "Asie",
    genus: "Cyriopagopus",
    species: "Cyriopagopus sp. Hati Hati"
  },
  {
    continent: "Asie",
    genus: "Haploclastus",
  ...
  },
  {
    continent: "Asie",
    genus: "Lampropelma",
    species: "Lampropelma sp. Borneo Black"
  },
  {
    continent: "Asie",
    genus: "Ornithoctoninae",
    species: "Ornithoctoninae sp. Hai Bia"
  },
  {
    continent: "Asie",
    genus: "Ornithoctoninae",
    species: "Ornithoctoninae sp. Vendula"
  },
  {
    continent: "Asie",
    genus: "Ornithoctoninae",
  ...
  },
{
  ...
  },
  {
    continent: "Asie",
    genus: "Poecilotheria",
    species: "Poecilotheria sp. Lowland"
  },
...
},
{
  ...
  latinName: "Heteroscodra maculata",
  commonName: "Togo Starburst Baboon",
  origin: "západní až střední Afrika (zejména Ghana, Togo a okolní oblasti)",
  type: "stromový sklípkan (arboreální druh)",
  adultSize: "přibližně 12–15 cm rozpětí nohou",
  lifespan: "samice až 12–15 let, samec přibližně 3–4 roky",

  logo: "img/logos/h.maculata-logo4.webp",
  ...
  characteristics: [
    ...
    {
      label: "Typ kokonu",
      value: "🕸️ plochý kokon (v pavučině)",
      options: [
        "⚪ kulovitý kokon",
        "🕸️ plochý kokon (v pavučině)"
      ]
  ...
  care: {
    terrarium: "vertikální typ s dostatkem prostoru na šplhání (např. 30×30×45 cm pro dospělce)",
    hides: "korková kůra, dutá větev nebo jiný vertikální úkryt umožňující vytvoření pavučinového tunelu",
    temperature: "přibližně 24–28 °C",
    humidity: "kolem 60–80 %",
    substrate: "kokosová drť nebo směs terarijní půdy (cca 5–8 cm)"
  },
...
},
{
  ...
  continent: "Afrika",
  genus: "Pterinochilus",
  species: "Pterinochilus murinus RCF",
  slug: "pterinochilus-murinus-rcf",

  latinName: "Pterinochilus murinus",
  colorForm: "RCF (Red Color Form)",
  commonName: "Orange Baboon Tarantula (OBT)",
  origin: "východní až jižní Afrika (např. Keňa, Tanzanie, Mosambik; druh je ale rozšířen i v dalších částech Afriky)",
  type: "terestriální sklípkan, který vytváří mělké nory a rozsáhlé zapředené úkryty",
  adultSize: "přibližně 13–15 cm rozpětí nohou",
  lifespan: "samice obvykle 8–12 let (výjimečně déle), samec 3–4 roky",

  logo: "img/logos/p.murinus.rcf-logo.webp",
  image: "img/spiders/pterinochilus-murinus-rcf.jpg",
  ...
  description: [
    ...
    "Zajímavostí je, že ačkoli bývá často prezentován jen jako „agresivní oranžový sklípkan“, z biologického hlediska je přesnější říkat, že je silně defenzivní. Nejde tedy o zvíře, které by aktivně „vyhledávalo útok“, ale o druh, který se při narušení velmi rozhodně brání. Další zajímavostí je existence více chovatelsky známých barevných forem, z nichž RCF je jedna z nejznámějších. Další chovatelsky označované barevné formy: TCF – Typical Color Form, DCF – Dark Color Form, OCF – Orange Color Form, UMV - Usambra Mountains form."
  ],

  care: {
    terrarium: "spíše horizontálně laděné terárium s dostatečnou plochou dna, vrstvou substrátu a kotevními body pro pavučiny (např. přibližně 30 × 20 × 20 cm nebo větší pro dospělého jedince)",
    hides: "korek, kusy kůry, duté větve nebo jiné opory, kolem kterých může vytvářet zapředené tunely",
    temperature: "cca 24–28 °C",
    humidity: "nižší až střední; vhodný je převážně sušší chov s miskou na vodu a případně jen lokálně mírně vlhčí částí substrátu",
    substrate: "kokosové vlákno, rašelina, směs vhodná k hrabání (10–15 cm)"
  },
...
const continents = ["Afrika", "Amerika", "Asie"];

window.speciesData = speciesData;
window.continents = continents;

window.hasSpeciesDetail = function(species) {
  return Boolean(species.slug);
};